import { MediaIcon, ResourcesIcon } from '../../../../constants/siteIcons';
import { useEffect, useRef, useState } from 'react';
import { createPortal } from 'react-dom';
import { AlignLeft, ArrowRight, Bold, CheckCircle2, ChevronDown, Globe2, Headphones, Image, Italic, Link2, List, ListOrdered, ListX, Loader2, MessageSquareQuote, Minus, Quote, Redo2, ScrollText, Search, Strikethrough, Subscript, Superscript, Type, Underline, Undo2, X } from 'lucide-react';
