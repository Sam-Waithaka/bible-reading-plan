...
import { discoveryMasonryColumnsClass } from '../../constants/responsive';
...
const ResourceMasonry = ({
  ...
  return (
    <div
      className={`box-border w-full max-w-full min-w-0 ${discoveryMasonryColumnsClass} gap-3 sm:gap-5 xl:gap-7 ${className}`}
